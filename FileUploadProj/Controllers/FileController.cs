...
using FileUploadProj.Models;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace FileUploadProj.Controllers
{
    public class FileController : Controller
    {
        ...
        private async Task<FileUploadViewModel> LoadAllFiles()
        {
            ...
            viewModel.FileOnDatabaseModel = await context.FilesOnDatabase.ToListAsync();
            viewModel.FileOnFileSystem = await context.FilesOnFileSystem.ToListAsync();
            return viewModel;
        }
        ...
        public async Task<IActionResult> UploadToDatabase(List<IFormFile> files, string description)
        {
            ...
            TempData["Message"] = "File sucessfully uploaded to Database";
            return RedirectToAction("Index");
        }
